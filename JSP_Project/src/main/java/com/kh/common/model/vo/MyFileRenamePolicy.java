...
public class MyFileRenamePolicy implements FileRenamePolicy{
	...
	public File rename(File origin) {
		...
		//원본 파일명 : 하하.txt
		//원본에서 .txt와 같이 확장자는 꼭 추출하여 변경된 이름에 추가해서 작성해야한다.
		...
		//3. 원본파일명에서 확장자 추출하기
		//확장자는 가장 마지막에 붙고 .xxx형식이기 때문에 뒤에서부터 .위치를 찾아 가장 먼저 찾아지는 .을 기준으로
		//나머지 부분을 잘라내면된다 lastIndexOf로 뒤에서부터 위치찾고 substring으로 잘라내기
