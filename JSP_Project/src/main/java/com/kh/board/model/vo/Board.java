...
public class Board {
	...
	//사진게시판 목록에서 필요한 썸네일용 경로와 변경된 파일 이름(서버에 업로드된 이름)을 합쳐 담을 필드 변수
	...
	public Board(int boardNo, int boardType, String category, String boardTitle, String boardContent, String boardWriter,
			int count, Date createDate, String satus) {
		super();
		this.boardNo = boardNo;
	...
	public void setBoardContet(String boardContent) {
		this.boardContent = boardContent;
	}
	...
	public String toString() {
		return "Board [boardNo=" + boardNo + ", boardType=" + boardType + ", category=" + category + ", boardTitle="
				...
				+ ", createDate=" + createDate + ", satus=" + satus + "]";
	}
